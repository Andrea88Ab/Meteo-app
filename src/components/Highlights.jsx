    ...
    <>
      <div className="highlight-container">
        <Card className="h-card">
          <div className="h-title">Umiditá</div>
        ...
        <Card className="h-card">
          <div className="h-title">Vento</div>
          <img
        ...
        <Card className="h-card">
          <div className="h-title">Nuvole</div>
        ...
        <Card className="h-card">
          <div className="h-title">Raggi UV</div>
          <img src="/weather_icons/uv.png" width={100} alt="" />
          <h1>{current.uvi}</h1>
        </Card>
        <Card className="h-card">
          <div className="h-title">Pressione</div>
